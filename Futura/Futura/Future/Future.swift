...
public final class Future<Value> {
    ...
    #if FUTURA_DEBUG
        internal init(with result: Result<Value>? = nil, executionContext: ExecutionContext, debug: DebugMode = .disabled) {
...
extension Future: CustomStringConvertible {
    public var description: String {
        return "Future<\(Value.self)>[0x\(String(unsafeBitCast(self, to: Int.self), radix: 16))]"
    }
}
